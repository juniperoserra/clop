...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ArgParser__ = __webpack_require__(117);
...
var createArgParser = function createArgParser(cli) {
    return new __WEBPACK_IMPORTED_MODULE_0__ArgParser__["a" /* default */](cli);
};
...
var chalk = __webpack_require__(118);
...
var ArgParser = function () {
    ...
    _createClass(ArgParser, [{
        ...
        key: 'parse',
        value: function parse(argv, continueAfterHelp) {
            var program = {};
            ...
            if (argv.length < 3 && !this._cmdsList.some(function (cmd) {
                ...
                var _selectCommand3 = _slicedToArray(_selectCommand2, 2);
        ...
        key: 'showHelp',
        value: function showHelp(continueAfterHelp) {
...
var escapeStringRegexp = __webpack_require__(300);
var ansiStyles = __webpack_require__(116);
var stripAnsi = __webpack_require__(303);
var hasAnsi = __webpack_require__(301);
var supportsColor = __webpack_require__(304);
