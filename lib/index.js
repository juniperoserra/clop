...
/* MIT license */
var cssKeywords = __webpack_require__(335);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ArgParser__ = __webpack_require__(329);
...
var chalk = __webpack_require__(330);
...
var ArgParser = function () {
  ...
  _createClass(ArgParser, [{
    ...
    key: 'validateValue',
    value: function validateValue(optionName, value) {
      var opt = this._optsHash[optionName];
    ...
    value: function parse(argv) {
      ...
      if (argv.length < 3 && !this._cmdsList.some(function (cmd) {
        ...
        var _parseOpts2 = _parseOpts(args, this._optsHash, this._errorHandler);

        var _parseOpts3 = _slicedToArray(_parseOpts2, 2);

        program.opts = _parseOpts3[0];
        err = _parseOpts3[1];
...
const escapeStringRegexp = __webpack_require__(331);
const ansiStyles = __webpack_require__(332);
const supportsColor = __webpack_require__(337);

const template = __webpack_require__(340);
...
const colorConvert = __webpack_require__(334);
...
const hasFlag = __webpack_require__(339);
